  ...
  const fetchEmployeeData = async () => {
    try {
      ...
      try {
        ...
        setAdvances(advancesRes.data.advances || advancesRes.data || [])
      } catch (error) {
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  {employee.alternate_phone && (
                    <div>
                      <p className="text-white/50 text-sm">Alternate Phone</p>
                      <p className="text-white">{employee.alternate_phone}</p>
                    </div>
                  )}
                  <div>
                    <p className="text-white/50 text-sm">Date of Birth</p>
                    <p className="text-white">{formatDate(employee.dob)}</p>
                  </div>
                  <div>
                  ...
                  <div>
                    <p className="text-white/50 text-sm">Marital Status</p>
                    <p className="text-white capitalize">{employee.marital_status || 'N/A'}</p>
                  </div>
                </div>

                <h3 className="text-white font-semibold mt-6 mb-3">Address</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white">{employee.city || 'N/A'}</p>
                  </div>
                  <div>
                    <p className="text-white/50 text-sm">State</p>
                    <p className="text-white">{employee.state || 'N/A'}</p>
                  </div>
                  <div>
                    <p className="text-white/50 text-sm">Pincode</p>
                    <p className="text-white">{employee.pincode || 'N/A'}</p>
                  </div>
                </div>

                <h3 className="text-white font-semibold mt-6 mb-3">Emergency Contact</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <p className="text-white/50 text-sm">Contact Name</p>
                    <p className="text-white">{employee.emergency_contact_name || 'N/A'}</p>
                  </div>
                  <div>
                    <p className="text-white/50 text-sm">Contact Phone</p>
                    <p className="text-white">{employee.emergency_contact_phone || 'N/A'}</p>
                  </div>
                </div>
              </div>
            )}
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  {employee.confirmation_date && (
                    <div>
                      <p className="text-white/50 text-sm">Confirmation Date</p>
                      <p className="text-white">{formatDate(employee.confirmation_date)}</p>
                    </div>
                  )}
                  {employee.exit_date && (
                    <div>
                      <p className="text-white/50 text-sm">Exit Date</p>
                      <p className="text-white">{formatDate(employee.exit_date)}</p>
                    </div>
                  )}
                </div>

                <h3 className="text-white font-semibold mt-6 mb-3">Statutory Details</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <p className="text-white/50 text-sm">PF Number</p>
                    <p className="text-white">{employee.pf_number || 'N/A'}</p>
                  </div>
                  <div>
                    <p className="text-white/50 text-sm">ESI Number</p>
                    <p className="text-white">{employee.esi_number || 'N/A'}</p>
                  </div>
                  <div>
                    <p className="text-white/50 text-sm">PAN Number</p>
                    <p className="text-white">{employee.pan_number || 'N/A'}</p>
                  </div>
                  <div>
                    <p className="text-white/50 text-sm">Aadhar Number</p>
                    <p className="text-white">{employee.aadhar_number || 'N/A'}</p>
                  </div>
                </div>
              </div>
            )}
              ...
              <div>
                <div className="flex justify-between items-center mb-4">
                  ...
                  <Link
                    ...
                    className="flex items-center gap-2 px-3 py-1.5 bg-pink-500/20 border border-pink-500/30  text-pink-400 rounded-lg hover:bg-pink-500/30 text-sm"
                  >
                    ...
                    <table className="w-full">
                      <thead className="bg-white/5">
                        <tr>
                          ...
                          <th className="px-4 py-2 text-left text-white/60 text-sm">Repayment</th>
                      ...
                      <tbody className="divide-y divide-white/10">
                        {advances.map((advance) => (
                          <tr key={advance.id} className="hover:bg-white/5">
                            ...
                            <td className="px-4 py-2 text-white">{formatCurrency(advance.repaid || 0)}</td>
